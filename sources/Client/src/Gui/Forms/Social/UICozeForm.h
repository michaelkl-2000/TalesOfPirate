...
public:
	...
	static void AddMsg(eChannel channel, std::string strWho, std::string strText, bool bSendTo = false,
...
namespace GUI {
	...
	public:
		...
		void OnPrivateMsg(std::string strFromName, std::string strToName, std::string strMsg,
						  DWORD dwColour = 0xFFFFFFFF);
	...
	protected:
		...
		void ReplaceSpecialFace(std::string& strMsg, const std::string& strReplace, const std::string& strFace);
