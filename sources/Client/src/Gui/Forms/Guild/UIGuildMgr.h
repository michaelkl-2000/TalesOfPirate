...
namespace GUI {
	...
	public:
		...
		static void UpdateGuildLogs(const Corsairs::Net::Msg::ActionUpdateGuildLogsData& data);
		static void RequestGuildLogs(const Corsairs::Net::Msg::ActionRequestGuildLogsData& data);
