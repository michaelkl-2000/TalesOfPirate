...
namespace GUI {
	...
	public:
		...
		void SetMaxHP(long v) {
			_nMaxHp = v;
		}

		void SetMaxSP(long v) {
			_nMaxSp = v;
		}
	...
	public:
		...
		static DWORD GetTeamLeaderID() {
			return _dwTeamLeaderID;
		}

		static void SetTeamLeaderID(DWORD v) {
			_dwTeamLeaderID = v;
		}
