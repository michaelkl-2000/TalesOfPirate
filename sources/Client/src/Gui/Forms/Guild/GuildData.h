...
public:
	...
	static void SetGuildID(const DWORD dwID) {
		m_dwID = dwID;
	}

	static DWORD GetGuildID() {
		return m_dwID;
	}
	...
	static std::string GetGuildName() {
		return m_strName;
	}
	...
	static std::string GetGuildMottoName() {
		return m_strMottoName;
	}

	static void SetGuildState(const eState state) {
		m_eState = state;
	}

	static eState GetGuildState() {
		return m_eState;
	}

	static void SetGuildLevel(const DWORD dwLv) {
		m_dwLv = dwLv;
	}

	static DWORD GetGuildLevel() {
		return m_dwLv;
	}

	static void SetGuildMasterID(const DWORD dwID) {
		m_dwMasterID = dwID;
	}

	static DWORD GetGuildMasterID() {
		return m_dwMasterID;
	}
	...
	static std::string GetGuildMasterName() {
		return m_strMasterName;
	}

	static void SetExperence(const __int64 i64Exp) {
		m_i64Exp = i64Exp;
	}

	static __int64 GetExperence() {
		return m_i64Exp;
	}

	static void SetMemberCount(const DWORD dwCount) {
		m_dwMemberCount = dwCount;
	}

	static DWORD GetMemberCount() {
		return m_dwMemberCount;
	}

	static void SetMaxMembers(const DWORD dwCount) {
		m_dwMaxMembers = dwCount;
	}

	static DWORD GetMaxMembers() {
		return m_dwMaxMembers;
	}

	static void SetRemainTime(const __int64 i64RemainTime) {
		m_i64RemainTime = i64RemainTime;
	}

	static __int64 GetRemainTime() {
		return m_i64RemainTime;
	}
