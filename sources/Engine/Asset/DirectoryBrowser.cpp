...
namespace Corsairs::Engine::Render {
	// DirectoryBrowser
	LW_STD_IMPLEMENTATION(DirectoryBrowser)

	DirectoryBrowser::DirectoryBrowser()
		: _proc(0), _param(0) {
	}

	LW_RESULT DirectoryBrowser::_Go(std::string_view file, DWORD flag) {
	...
	LW_RESULT DirectoryBrowser::Browse(std::string_view file, DWORD flag) {
