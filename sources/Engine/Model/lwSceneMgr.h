...
namespace Corsairs::Engine::Render {
	...
	public:
		...
		lwIViewFrustum* GetViewFrustum() {
			return _vf;
		}

		DWORD GetMaxSortNum() const {
			return _max_sort_num;
		}

		void GetCullPrimitiveInfo(lwCullPriInfo* info) {
			*info = _cull_pri_info;
		}

		lwSceneFrameInfo* GetSceneFrameInfo() {
			return &_frame_info;
		}
	};
