...
public:
	...
	virtual void SetColor(D3DXCOLOR dwColor) {
		_dwColor = dwColor;
	}
...
public:
	...
	void SetRenderIndex(int idx) {
		_pShadeMap->SetRenderIndex(idx);
	}

	void SetUpdate() {
		_pShadeMap->SetUpdate();
	}
