...
#define defKITBAG_DEFPUSH_POS	-1 //
	...
	public:
		...
		std::int32_t GetDBParam(short sParamID, short sPosID, short sType = 0);
		short SetDBParam(short sParamID, std::int32_t lParamVal, short sPosID, short sType = 0);
