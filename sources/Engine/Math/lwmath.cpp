...
namespace Corsairs::Engine::Render {
	...
	lwMatrix44* lwMatrix44Compose(lwMatrix44* matrix, const lwVector3* pos, const lwVector3* face,
								  const lwVector3* up) {
		// identity
	...
	inline float MINOR(const lwMatrix44& m, const int r0, const int r1, const int r2, const int c0, const int c1,
					   const int c2) {
