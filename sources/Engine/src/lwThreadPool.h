...
namespace Corsairs::Engine::Render {
	...
	private:
		...
		inline BOOL _SetEvent() {
			return ::SetEvent(_event_signal);
		}

		inline BOOL _ResetEvent() {
			return ::ResetEvent(_event_signal);
		}
