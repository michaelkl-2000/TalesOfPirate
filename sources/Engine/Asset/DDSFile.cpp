...
namespace Corsairs::Engine::Render {
	...
	LW_RESULT DDSFile::LoadOriginTexture(std::string_view file, DWORD mip_level, D3DFORMAT format, DWORD colorkey) {
	...
	LW_RESULT DDSFile::Compress(D3DFORMAT new_fmt) {
		LW_RESULT ret = LW_RET_FAILED;
	...
	HRESULT DDSFile::BltAllLevels(D3DCUBEMAP_FACES FaceType, IDirect3DBaseTextureX* ptexSrc,
	...
	LW_RESULT DDSFile::Convert(std::string_view file, D3DFORMAT src_fmt, D3DFORMAT dds_fmt, DWORD mip_level,
								 DWORD src_colorkey) {
		LW_RESULT ret = LW_RET_FAILED;
