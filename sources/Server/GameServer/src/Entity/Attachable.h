...
public:
	...
	void SetShip(CPassengerMgr* pCShip) {
		m_pCShip = pCShip;
	}

	CPassengerMgr* GetShip(void) {
		return m_pCShip;
	}

	void SetShipMaster(CAttachable* pCShipM) {
		m_pCShipMaster = pCShipM;
	}

	CAttachable* GetShipMaster(void) {
		return m_pCShipMaster;
	}
