...
namespace Corsairs::Engine::Render {
	...
	public:
		...
		DWORD GetKeyPositionNum() const {
			return _pos_num;
		}

		DWORD GetKeyRotationNum() const {
			return _rot_num;
		}

		DWORD GetKeyScaleNum() const {
			return _sca_num;
		}
	};
	...
	public:
		...
		DWORD GetKeyCapacity() {
			return _data_capacity;
		}

		DWORD GetBeginKey() {
			return _data_num > 0 ? _data_seq[0].key : 0;
		}

		DWORD GetEndKey() {
			return _data_num > 0 ? _data_seq[_data_num - 1].key : 0;
		}
	};
