...
namespace Corsairs::Engine::Render {
	DWORD lwTreeNodeEnumPreOrder(lwITreeNode* node, lwTreeNodeEnumProc proc, void* param) {
	...
	DWORD lwTreeNodeEnumInOrder(lwITreeNode* node, lwTreeNodeEnumProc proc, void* param) {
		LW_RESULT ret = TREENODE_PROC_RET_CONTINUE;
	...
	DWORD lwTreeNodeEnumPostOrder(lwITreeNode* node, lwTreeNodeEnumProc proc, void* param) {
		LW_RESULT ret = TREENODE_PROC_RET_CONTINUE;
	...
	DWORD lwTreeNodeEnumPreOrder_Ignre(lwITreeNode* node, lwTreeNodeEnumProc proc, void* param) {
		LW_RESULT ret = TREENODE_PROC_RET_CONTINUE;
	...
	LW_RESULT lwTreeNode::EnumTree(lwTreeNodeEnumProc proc, void* param, TreeNodeProcType enum_type) {
		LW_RESULT ret = LW_RET_FAILED;

		switch (enum_type) {
		case TreeNodeProcType::TREENODE_PROC_PREORDER:
			ret = lwTreeNodeEnumPreOrder(this, proc, param);
			break;
		case TreeNodeProcType::TREENODE_PROC_INORDER:
			ret = lwTreeNodeEnumInOrder(this, proc, param);
			break;
		case TreeNodeProcType::TREENODE_PROC_POSTORDER:
			ret = lwTreeNodeEnumPostOrder(this, proc, param);
			break;
		case TreeNodeProcType::TREENODE_PROC_PREORDER_IGNORE:
