...
// 
extern void CS_BlackMarketExchangeReq(DWORD dwNpcID, short sSrcID, short sSrcNum, short sTarID, short sTarNum,
									  short sTimeNum, BYTE byIndex);
...
extern void CS_RequestDailyBuffInfo();
//
...
extern BOOL SC_DailyBuffInfo(LPRPACKET packet);
// 
