...
namespace Corsairs::Engine::Render {
	...
	private:
		...
		std::deque<ThreadTaskInfo> _queue_task;
	...
	public:
		...
		LW_RESULT Destroy();
		LW_RESULT RegisterTask(ThreadProc proc, void* param);
		LW_RESULT RemoveTask(ThreadProc proc, void* param);
		LW_RESULT FindTask(ThreadProc proc, void* param);
