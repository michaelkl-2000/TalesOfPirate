...
namespace Corsairs::Engine::Render {
	...
	LW_RESULT lwDeviceObject::CreateVertexBuffer(UINT length, DWORD usage, DWORD fvf, D3DPOOL pool,
	...
	LW_RESULT lwDeviceObject::CreateIndexBuffer(UINT length, DWORD usage, D3DFORMAT fmt, D3DPOOL pool,
	...
	LW_RESULT lwDeviceObject::CreateTexture(IDirect3DTextureX** out_tex, const lwTexDataInfo* info, DWORD level,
	...
	LW_RESULT lwDeviceObject::CreateTexture(IDirect3DTextureX** out_tex, UINT width, UINT height, UINT level,
	...
	LW_RESULT lwDeviceObject::CreateTextureFromFileInMemory(IDirect3DTextureX** out_tex, void* data, UINT data_size,
	...
	LW_RESULT lwDeviceObject::CreateRenderTarget(IDirect3DSurfaceX** o_surface, UINT width, UINT height,
	...
	LW_RESULT lwDeviceObject::CreateDepthStencilSurface(IDirect3DSurfaceX** o_surface, UINT width, UINT height,
														D3DFORMAT format, D3DMULTISAMPLE_TYPE multi_sample,
	...
	LW_RESULT lwDeviceObject::CreateCubeTexture(IDirect3DCubeTextureX** o_tex, UINT edge_length, UINT levels,
	...
	LW_RESULT lwDeviceObject::CreateOffscreenPlainSurface(IDirect3DSurfaceX** surface, UINT width, UINT height,
	...
	LW_RESULT lwDeviceObject::SetStreamSource(UINT stream_num, IDirect3DVertexBufferX* stream_data, UINT offset_byte,
											  UINT stride) {
		LW_RESULT ret = LW_RET_FAILED;
	...
	LW_RESULT lwDeviceObject::DrawIndexedPrimitive(D3DPRIMITIVETYPE pt_type, INT base_vert_index, UINT min_index,
	...
	LW_RESULT lwDeviceObject::DrawIndexedPrimitiveUP(D3DPRIMITIVETYPE pt_type, UINT min_vert_index, UINT vert_num,
