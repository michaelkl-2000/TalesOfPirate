...
namespace Corsairs::Engine::Render {
	...
	public:
		...
		void SetMatrixParent(const lwMatrix44* mat) {
			_mat_parent = *mat;
		}
	};
	...
	public:
		...
		virtual int IsValidObject() const {
			return _obj_num > 0;
		}

		virtual lwBoundingBoxInfo* GetDataInfoWithID(DWORD obj_id);

		virtual lwBoundingBoxInfo* GetDataInfo(DWORD id) {
			return &_obj_seq[id];
		}

		virtual DWORD GetObjNum() const {
			return _obj_num;
		}

		lwMatrix44* GetMatrixParent() {
			return &_mat_parent;
		}
	...
	public:
		...
		virtual lwBoundingSphereInfo* GetDataInfo(DWORD id) {
			return &_obj_seq[id];
		}
	...
	public:
		...
		virtual lwMatrix44* GetMatrixParent() {
			return &_mat_parent;
		}
	...
	public:
		...
		lwIBoundingBox* GetBoundingBox() {
			return _obj_boundingbox;
		}

		lwIBoundingSphere* GetBoundingSphere() {
