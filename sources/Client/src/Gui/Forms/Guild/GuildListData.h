...
public:
	...
	std::string GetGuildMasterName() {
		return m_strMasterName;
	}

	void SetExperence(__int64 i64Exp) {
		m_i64Exp = i64Exp;
	}

	__int64 GetExperence() {
		return m_i64Exp;
	}

	void SetMembers(DWORD dwMemberCount) {
		m_dwMembers = dwMemberCount;
	}
