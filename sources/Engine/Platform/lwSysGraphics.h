...
namespace Corsairs::Engine::Render {
	...
	public:
		...
		static void SetActiveIGraphicsSystem(lwISysGraphics* sys) {
			__sys_graphics = sys;
		}

		static lwISysGraphics* GetActiveIGraphicsSystem() {
	...
	public:
		...
		lwICoordinateSys* GetCoordinateSys() {
			return &_coord_sys;
		}
